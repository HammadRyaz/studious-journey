export const workingWithObject = () => {
    // const gamer = {
    //     name: 'Dave',
    //     score: 0,
    ...
    Parent.prototype.logData = function () {
        const childEvent = Child.prototype.logData.call(this);
        return `${childEvent} role: ${this.role} `
    }
